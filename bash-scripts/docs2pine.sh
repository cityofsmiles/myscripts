...
rsync -av --delete --rsh='ssh -p22' --exclude-from=/home/jonathan/Documents/myscripts/bash-scripts/exclude-files.txt /home/jonathan/Documents/ $user_pine@$ip_pine:/home/jonathan/Documents/laptop &&
