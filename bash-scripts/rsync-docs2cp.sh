...
rsync -av --delete  --rsh='ssh -p8022' --exclude-from=/home/jonathan/Documents/myscripts/bash-scripts/exclude-files.txt /home/jonathan/Documents/ $user_cp@$ip_cp:/storage/4A3C-18EA/Android/data/com.termux/files/Document &&
